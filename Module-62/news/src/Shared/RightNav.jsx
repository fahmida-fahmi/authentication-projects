...
const RightNav = () => {
    return (
        <div>
            <div>
                <h4>Login With</h4>
                <Button variant="outline-primary" className='px-5 mt-4 w-full'> <FaGoogle className='inline me-2 text-2xl' />  Log in with Google</Button>
                <Button variant="outline-dark" className='px-5 my-3 w-full'> <FaGithub className='inline me-2 text-2xl' />  Log in with Github</Button>
            </div>
            <div className='mt-5'>
