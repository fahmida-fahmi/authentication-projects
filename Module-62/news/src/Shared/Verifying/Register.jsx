                ...
                <Form onSubmit={handleLogin} className='bg-white mt-12 p-10 px-16 w-3/5 mx-auto'>
                    ...
                    <div className='pt-5 px-4 border-t-2'>
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            ...
                            <Form.Control className='p-3 bg-light' type="email" name='name' placeholder="Enter your name" required/>

                        </Form.Group>
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            <Form.Label className='font-bold'>Photo URL</Form.Label>
                            <Form.Control className='p-3 bg-light' type="email" name='photoUrl'  placeholder="Enter Your Photo URL" required/>
                        ...
                        <Button variant="dark" type="submit" className='w-full my-4 rounded p-3 '>
                            <p className='mb-0 font-semibold'>Register</p>
                        </Button>
